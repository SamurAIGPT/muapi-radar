...
export const CREDENTIAL_FIELDS: Record<string, CredField[]> = {
  muapi: [
    { env: 'MUAPI_API_KEY', label: 'Muapi API Key', hint: 'Commercial social search, news & reviews from app.muapi.com', secret: true },
    { env: 'MUAPI_BASE_URL', label: 'Muapi Base URL', hint: 'Default: https://api.muapi.com', secret: false },
  ],
  anthropic: [
